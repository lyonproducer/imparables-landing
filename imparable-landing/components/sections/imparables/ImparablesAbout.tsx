    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <GlassCard className="p-8 md:p-12 border-white/15 bg-background-elevated/80">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-4 flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <span className="text-xs font-mono font-semibold uppercase tracking-widest text-accent mb-1">
              ...
              <div className="lg:col-span-8 flex flex-col gap-5 text-muted-foreground text-sm sm:text-base leading-relaxed border-t lg:border-t-0 lg:border-l border-white/10 pt-6 lg:pt-0 lg:pl-8">
                ...
                {/* Quote Box */}
                <div className="relative mt-2 p-5 rounded-xl bg-white/[0.03] border border-white/10 flex items-start gap-3.5">
        ...
        <div className="mb-16 text-center">
          <span className="text-xs font-mono font-semibold uppercase tracking-widest text-accent block mb-2">
            NUESTRA METODOLOGÍA
          </span>
          ...
          {methodSteps.map((step) => {
            ...
            return (
              <motion.div
                ...
                className="flex flex-col p-6 rounded-[var(--radius-card)] bg-background-elevated/60 border border-border hover:border-accent/40 transition-colors duration-300"
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 rounded-xl bg-accent/15 text-accent flex items-center justify-center">
                    <Icon size={22} weight="duotone" />
                  </div>
                  <span className="font-mono text-xs font-bold text-accent/80">
                    {step.num}
                  </span>
                </div>
